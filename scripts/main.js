  ...
  var html =
      '<div class="post post-' + postId + ' mdl-cell mdl-cell--12-col ' +
        ...
        '<div class="mdl-card mdl-shadow--2dp">' +
          '<div class="mdl-card__title mdl-color--crack mdl-color-text--white">' +
...
function startDatabaseQueries() {
  ...
  var recentPostsRef = firestore.collection("posts").limit(100);
  var userPostsRef = firestore.collection('posts').where('uid', '==', myUserId);
  ...
  var fetchPosts = function(postsRef, sectionElement) {
    ...
    querySnapshot.docChanges().forEach(change => {
      ...
      createPostElement(change.doc.id, change.doc.data().title, change.doc.data().body, author, change.doc.data().uid, change.doc.data().authorPic),
